...
def ipid(zombie):
    ...
    if reply2[IP].id == (reply1[IP].id + 2):
        print "IPID seqence is incremental and target appears to be idle. ZOMBIE LOCATED"
        ...
        print "Either the IPID sequence is not incremental or the target is not edle. NOT A GOOD ZOMBIE"
